...
// rect with optional temp field (used for heaters)
...
const LEVELS = [
  {
    ...
    ambient:0,
    timer:55, need:0.25,
    heaters:[ rect(40,30,4,12, 260) ],                             // burner at the mouth
    walls:[ rect(48,26,24,4), rect(48,42,24,4), rect(68,26,4,20) ],// pocket: top, bottom, right
    ice:   rect(50,32,18,9),                                      // cube inside; mouth (4-cell gap) faces left
  ...
  },
  {
    ...
    ambient:-10,
    timer:48, need:0.25,
    heaters:[ rect(42,22,16,4, 260), rect(42,52,16,4, 260) ],     // burners at top & bottom mouths
  ...
  },
  {
    ...
    ambient:-10,
    timer:54, need:0.50,
    heaters:[ rect(40,16,20,4, 260) ],                             // wide burner over a wide top mouth
