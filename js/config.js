...
const SUBSTEPS = 6;             // physics substeps / frame
...
const HEATER_T = 190;           // heater fixed temp (C)
...
const CONVECT  = 0.016;         // ambient relaxation coeff for air (convection/radiation approx)
